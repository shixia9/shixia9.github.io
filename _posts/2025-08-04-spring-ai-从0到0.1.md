...
> [https://spring.io/blog/2025/05/20/spring-ai-1-0-GA-released](https://spring.io/blog/2025/05/20/spring-ai-1-0-GA-released)
...
因为只是简单的对话模型，所以在这里就只引用了基础的`spring-ai-starter-model-openai`openai模型依赖，像是其他的ai功能，RAG、MCP等等可以各取所需引入需要的包(`spring-ai-starter-vector-store-pgvector`,`spring-ai-starter-mcp-client-webflux`,`spring-ai-tika-document-reader`等等。。)

> [https://docs.springframework.org.cn/spring-ai/reference/api/chat/openai-chat.html](https://docs.springframework.org.cn/spring-ai/reference/api/chat/openai-chat.html)
